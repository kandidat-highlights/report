...
% "Variables"
\newcommand{\varthetitle}{Deep learning for automatic mentions and highlights}
\newcommand{\varthesubtitle}{The use of artificial neural networks to do cool stuff (fix)}
